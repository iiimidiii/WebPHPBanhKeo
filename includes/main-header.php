...
<div class="logo">
	   <a class="navbar-brand" href="index.php"><img src="./img/Logo.png" alt="logo" style="width:200px;height:60px;"></a>
...
<div class="search-area">
    <form name="search" method="post" action="search-result.php">
        <div class="control-group">
            ...
            <input class="search-field" placeholder="Nhập từ khóa cần tìm kiếm..." name="product" required="required" />
	...
	?>
				...
				<div class="cart-item product-summary">
					<div class="row">
						...
						<div class="col-xs-7">
							...
							<div class="price"><?php echo ($row['productPrice']+$row['shippingCharge']); ?>*<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?>VND</div>
						</div>
			...
			<div class="clearfix cart-total">
				<div class="pull-right">
						...
						<span class="text">Tổng :</span><span class='price'><?php echo $_SESSION['tp']="$totalprice". ".00 "; ?> VND</span>
...
<div class="dropdown dropdown-cart">
		<a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
			<div class="items-cart-inner">
				<div class="total-price-basket">
					<span class="lbl">Giỏ hàng hiện tại -</span>
					<span class="total-price">
