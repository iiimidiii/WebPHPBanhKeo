			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						Tổng giá tiền<span class="inner-left-md"><?php echo $_SESSION['tp']="$totalprice". " VND"; ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary">Thanh toán ngay!!</button>
